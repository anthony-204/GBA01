...
A functional starting point lives in **`fuse-tool/`**:

- TypeScript calculation engine with Excel/MATLAB bug fixes
- JSON data migrated from Excel (37 machines)
- Vitest automated tests (12 passing)
- Next.js mobile-friendly web UI
- Full documentation in `fuse-tool/docs/`

See **[fuse-tool/README.md](../fuse-tool/README.md)** and **[fuse-tool/docs/PHASE1_COMPLETED.md](../fuse-tool/docs/PHASE1_COMPLETED.md)**.

## References

| Resource | Path |
|----------|------|
| **Phase 1 app** | `fuse-tool/` |
